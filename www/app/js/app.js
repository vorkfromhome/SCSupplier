...
(function () {
    ...
    function RegisterFormController($http, $state, toaster) {
        ...
        function getRegisterCulture() {
            ...
            $http.get('http://socialcommerce.ngrok.io/labels?URL=/register&Culture=' + lang).then(function (response) {
                if (lang == 'EN') {
        ...
        function activate() {
            ...
            vm.register = function () {
                ...
                if (vm.registerForm.$valid) {
                    ...
                    //http://localhost:3000
                        .post('http://socialcommerce.ngrok.io/register', {
                        email: vm.account.email
...
(function () {
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper) {
        ...
        $urlRouterProvider.otherwise('/page/numreg');
        //
        // Application Routes
        // -----------------------------------
        $stateProvider.state('app', {
            ...
            .state('page', {
                ...
                url: '/numreg'
                , title: 'numreg'
                , templateUrl: 'app/pages/numreg.html'
            }).state('page.profile', {
                url: '/profile'
                , title: 'profile'
            ...
            .state('app.addcategories', {
                ...
                , title: 'editproducts'
                , templateUrl: helper.basepath('updateproducts.html')
            }).state('page.profiletwo', {
                url: '/profiletwo'
                , title: 'profiletwo'
                ...
                url: '/newlogin'
                , title: 'newlogin'
                , templateUrl: 'app/pages/newlogin.html'
            }).state('page.forgetpass', {
                url: '/forgetpass'
                , title: 'forgetpass'
                , templateUrl: 'app/pages/forgetpass.html'
            }).state('page.otp', {
                url: '/otp'
                , title: 'otp'
                , templateUrl: 'app/pages/otp.html'
            }).state('page.register', {
                url: '/register'
                , title: 'Register'
...
//custom login validations for the pages
//----------------------------------------------------------------------
// Numberreg validations....
var mobilenum = '9876543210';
(function () {
    'use strict';
    angular.module('app.forms').controller('NumberregController', NumberregController);

    function NumberregController($scope, $http, $location) {
        var vm = this;
        vm.mobile = '';
        vm.truemobile = '';
        vm.confmobile = '';
        vm.otpcode = Math.floor(Math.random() * 1000000 + 1);
        var today = new Date();
        ...
        vm.todayfrmt = mm + '/' + dd + '/' + yyyy;
        vm.securenum = function () {
            var set = vm.mobile.length;
            var endstr = set + 1;
            var str = vm.mobile;
            console.log(vm.truemobile);
            if (set <= 7) {
                vm.mobile = vm.mobile.replace(/[0-9\.]/g, 'X');
            }
        };
        vm.submitted = false;
        vm.validateInput = function (name, type) {
        ...
        vm.submitForm = function () {
            ...
            if (vm.formValidate.$valid) {
                console.log('Submitted!!');
                mobilenum = vm.mobile;
                var todaynow = vm.todayfrmt;
                var otpcodedgts = vm.otpcode;
                console.log(vm.mobile);
                $http.get("http://localhost:8000/checkmobnum?mobilenum=" + vm.mobile).then(function (response) {
                    var count = response.data.count;
                    if (count > 0) {
                        console.log(count + ' = already exit!');
                    }
                    else {
                        console.log(count);
                        $http.get("http://localhost:8000/mobileregister?mobilenum=" + vm.mobile + "&datenow=" + todaynow + "&status=1&active=0&otpdigits=" + otpcodedgts + "&password=12345678").then(function (response) {
...
(function () {
    'use strict';
    angular.module('app.forms').controller('OtpController', OtpController);
    OtpController.$inject = ['$timeout', '$http', '$location'];
    //NotifyDemoCtrl
    function OtpController($scope, $http, $location, $timeout) {
        var vm = this;
        vm.otp = '';
        vm.otpresult = '';
        var limits = 0;
        var mins = 120;
        vm.limitscontent = "Wait 2 mins"
        vm.sendotp = false;
        vm.otpcodeagain = Math.floor(Math.random() * 1000000 + 1);
        vm.sendotpagain = function () {
            $http.get("http://localhost:8000/createotpagain?otpagain=" + vm.otpcodeagain + "&mobilenum=" + mobilenum).then(function (response) {
                console.log(response.data);
                limits++;
                if (limits == 5) {
                    limits = 0;
                    vm.sendotp = true;
                    vm.alerts = ['Wait A Mins...'];
                    var timeset = mins * 1000;
                    $timeout(function () {
                        vm.sendotp = false;
                    }, timeset);
                    console.log(mins);
        ...
        vm.submitForm = function () {
            ...
            if (vm.formValidate.$valid) {
                console.log('Submitted!!');
                $http.get("http://localhost:8000/otpchecking?otpcheck=" + vm.otp + "&mobilenum=" + mobilenum).then(function (response) {
                    console.log(response.data);
                    var count = response.data.count;
                    if (count > 0) {
                        $location.path("/page/profile");
                    }
                    else {
...
(function () {
    'use strict';
    angular.module('app.forms').controller('ProfileController', ProfileController);
    ...
    function ProfileController($scope, $http, $location) {
        ...
        vm.submitForm = function () {
            ...
            if (vm.formValidate.$valid) {
                console.log('Submitted!!');
                $http.get("http://localhost:8000/profileregister?&name=" + vm.name + "&email=" + vm.email + "&secure_question=" + vm.securityquestion + "&secure_answer=" + vm.qustnanswer + "&country=" + vm.Country + "&state=" + vm.State + "&zip=" + vm.zip + "&doorno=" + vm.doorno + "&floor=" + vm.floor + "&addressone=" + vm.addressone + "&addresstwo=" + vm.addresstwo + "&taluk=" + vm.Taluk + "&mobilenum=" + mobilenum).then(function (response) {
                    console.log(response.data);
                    $location.path("/page/profiletwo");
                });
            }
            else {
                console.log('Not valid!!');
...
//profiletwo validations....
(function () {
    'use strict';
    angular.module('app.forms').controller('ProfileTwoController', ProfileTwoController);

    function ProfileTwoController($scope, $http, $location) {
        var vm = this;
        vm.submitted = false;
        vm.validateInput = function (name, type) {
            var input = vm.formValidate[name];
        ...
        vm.submitForm = function () {
            ...
            if (vm.formValidate.$valid) {
                console.log('Submitted!!');
                $http.get("http://localhost:8000/profiletworegister?busname=" + vm.busname + "&License=" + vm.License + "&tin=" + vm.tin + "&vat=" + vm.vat + "&FAX=" + vm.FAX + "&busmobile=" + vm.busmobile + "&email=" + vm.email + "&mobilenum=" + mobilenum).then(function (response) {
                    console.log(response.data);
...
// validation for newlogin........
(function () {
    'use strict';
    angular.module('app.forms').controller('NewloginController', NewloginController);

    function NewloginController($scope, $http, $location) {
        var vm = this;
        vm.submitted = false;
        vm.validateInput = function (name, type) {
            var input = vm.formValidate[name];
        ...
        vm.submitForm = function () {
            ...
            if (vm.formValidate.$valid) {
                console.log('Submitted!!');
                $http.get("http://localhost:8000/userlogin?username=" + vm.username + "&password=" + vm.password).then(function (response) {
                    console.log(response.data);
                    var count = response.data.loginstatus;
                    if (loginstatus > 0) {
...
// validation for forgetpass........
(function () {
    'use strict';
    angular.module('app.forms').controller('ForgetPassController', ForgetPassController);

    function ForgetPassController($scope, $http, $location) {
        var vm = this;
        vm.submitted = false;
        vm.validateInput = function (name, type) {
            var input = vm.formValidate[name];
        ...
        vm.submitForm = function () {
            ...
            if (vm.formValidate.$valid) {
                console.log('Submitted!!');
                $http.get("http://localhost:8000/forgetpass?username=" + vm.username + "&securityquestion=" + vm.securityquestion + "&qustnanswer=" + vm.qustnanswer).then(function (response) {
                    var count = response.data.count;
                    if (count > 0) {
                        $location.path("/page/newlogin");
                    }
...
// validation for inventoryController.........
(function () {
    'use strict';
    angular.module('app.dashboard').controller('inventoryController', inventoryController);

    function inventoryController($scope, $http,$state, $location) {
        var vm = this;
        vm.submitted = false;
        vm.addinventry = function() {
         $state.go("app.addproducts"); 
         
        };
        vm.editproducts = function(id){
            $state.go("app.editproducts",{'updateid':id}); 
        };
            activate();
        ////////////////
        function activate() {
           $http.get("http://localhost:8000/seller/listproducts?id=").then(function (response) {
                    console.log(response.data);
                vm.productdata = response.data.result;
                });
        }
        vm.delproducts = function(id){
         $http.get("http://localhost:8000/seller/delproducts?status=0&id="+id).then(function (response) {
                   console.log(response.data);
                   activate();
                });    
        };
...
(function () {
    'use strict';
    angular.module('app.dashboard').controller('demoformController', demoformController);

    function demoformController($scope, $http,$state, $location) {
        var vm = this;
        vm.submitted = false;
        vm.addinventry = function() {
         $state.go("app.addproducts"); 
...
(function () {
    'use strict';
    angular.module('app.forms').controller('AddproductsController', AddproductsController);

    function AddproductsController($scope, $http,$state, $location) {
        var vm = this;
        vm.submitted = false;
        vm.validateInput = function (name, type) {
            var input = vm.formValidate[name];
       ...
       if(vm.updateid!=undefined)
       {
        ...
        $http.get("http://localhost:8000/seller/listproducts?id=" + vm.updateid).then(function (response) {
            vm.setdata = response.data.result[0];
            console.log(vm.setdata);
            vm.Sellerinfo = vm.setdata.sellerinfo;
            vm.Productinfo = vm.setdata.productsinfo;
            vm.qty = vm.setdata.qty;
            vm.metrices = vm.setdata.metrices;
            vm.dateofinventory = vm.setdata.dateofinventory;
            vm.expirydate = vm.setdata.expiredate;
        ...
        vm.submitForm = function () {
            ...
            if (vm.formValidate.$valid) {
               ...
               if(vm.updateid==undefined)
                    {
                 $http.get("http://localhost:8000/seller/addproducts?sellerinfo=" + vm.Sellerinfo + "&productsinfo=" + vm.Productinfo + "&qty=" + vm.qty + "&metrices=" + vm.metrices + "&dateofinventory=" + vm.dateofinventory + "&expiredate=" + vm.expirydate + "&activestatus=" + vm.activestatus+"&status=1").then(function (response) {
                    console.log(response.data);
                    $state.go("app.inventory"); 
                });
                    }else {
                      $http.get("http://localhost:8000/seller/updateproducts?activestatus=" + vm.activestatus+ "&updateid=" + vm.updateid+ "&status=1").then(function (response) {
                    console.log(response.data);
                    $state.go("app.inventory"); 
                });  
                    }
        ...
        function activate() {
            vm.today = function () {
                vm.dt = new Date();
                if(vm.dateofinventory!=""){
                    vm.dt = new Date(vm.dateofinventory);
                }
            };
            vm.today();
            vm.clear = function () {
